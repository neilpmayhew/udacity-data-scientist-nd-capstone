...
class Time2VecTransformer():
    ...
    def fit(self,X_train,y_train,X_val,y_val,batch_size,epochs):
        callback = tf.keras.callbacks.ModelCheckpoint(f'{self.model_name}.hdf5',
                                                    monitor='val_loss',
        ...
        self.best_model = tf.keras.models.load_model(f'{self.model_name}.hdf5',
